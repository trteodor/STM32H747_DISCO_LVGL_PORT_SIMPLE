...
void ui_Screen2_screen_init(void)
{
    ...
    lv_obj_set_x(ui_Arc1, -266);
    lv_obj_set_y(ui_Arc1, 312);
    ...
    lv_obj_set_x(ui_Arc2, 200);
    lv_obj_set_y(ui_Arc2, 352);
    ...
    lv_obj_set_x(ui_Arc5, 208);
    lv_obj_set_y(ui_Arc5, 528);

    lv_obj_set_align(ui_Arc5, LV_ALIGN_CENTER);

    lv_arc_set_range(ui_Arc5, 0, 100);
    lv_arc_set_bg_angles(ui_Arc5, 120, 60);
